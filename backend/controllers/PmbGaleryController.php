...
use Yii;
use backend\models\PmbGalery;
use backend\models\PmbGalerySearch;
...
class PmbGaleryController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            $model->file_foto = 'upload/galery/' . $model->file->baseName . '.' . $model->file->extension;
            if ($model->validate() && $model->save()) {
                $model->file->saveAs('upload/galery/' . $model->file->baseName . '.' . $model->file->extension);
            }
