...
/**
 * PmbRincianBiayaSearch represents the model behind the search form about `backend\models\PmbRincianBiaya`.
 */
class PmbRincianBiayaSearch extends PmbRincianBiaya
{
    ...
    {
        return [
            [['id_rincian_biaya', 'id_biaya_pendidikan', 'created_by', 'updated_by', 'active'], 'integer'],
