...
use backend\models\PmbPendaftaran;

/**
 * PmbPendaftaranSearch represents the model behind the search form about `backend\models\PmbPendaftaran`.
 */
class PmbPendaftaranSearch extends PmbPendaftaran
{
    ...
    public function rules()
    {
        return [
            ...
            [['jadwal_awal', 'jadwal_akhir', 'tgl_pengumuman', 'tgl_ujian', 'tgl_mendaftar_ulang', 'created_at', 'updated_at'], 'safe'],
            [['biaya_daftar'], 'number'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'tgl_mendaftar_ulang' => $this->tgl_mendaftar_ulang,
            'id_usm' => $this->id_usm,
